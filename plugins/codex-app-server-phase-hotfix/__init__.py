...
from .model_controls import patch_codex_model_controls
...
def register(ctx):
    ...
    model_status = patch_codex_model_controls()
    ...
    logger.info("codex-app-server-phase-hotfix: model controls %s", model_status)
    logger.info(
